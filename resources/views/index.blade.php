                    ...
                    <div class="col-lg-3 col-md-6 text-center position-relative">
                        @if ($sambutan->foto)
                            <img src="{{ asset('storage/' . $sambutan->foto) }}"
                                class="img-fluid rounded-md shadow-lg mb-3" alt="{{ $sambutan->judul }}">
                            <div class="nametag">
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4 justify-content-center mb-4">
                    ...
                    <div class="col">
                        <a href="{{ route('bagian-umum-dan-kepegawaian') }}" class="text-decoration-none">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                <img src="assets/images/job/047-teamwork.png" class="avatar avatar-ex-sm"
                                    alt="">
                                <div class="flex-1 ms-3">
                    ...
                    <div class="col">
                        <a href="{{ route('seksi-pelayanan-umum') }}" class="text-decoration-none">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                <img src="assets/images/job/031-learning.png" class="avatar avatar-ex-sm"
                                    alt="">
                                <div class="flex-1 ms-3">
                    ...
                    <div class="col">
                        <a href="{{ route('seksi-pemerintahan-umum') }}" class="text-decoration-none">
                            <div class="d-flex key-feature align-items-center p-3 rounded shadow">
                                <img src="assets/images/job/008-check-list.png" class="avatar avatar-ex-sm"
                                    alt="">
                                <div class="flex-1 ms-3">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-6">
                    ...
                    {{-- <div class="instagram-post">
                        <!-- Letakkan kode embed Instagram di sini -->
                        <blockquote class="instagram-media"
                            data-instgrm-permalink="https://www.instagram.com/reel/DAqJV4WvgEp/"
                            data-instgrm-version="14" style=" max-width:540px; min-width:326px;">
