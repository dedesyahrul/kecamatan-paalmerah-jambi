...
<body>
            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="title-heading">
                        ...
                        <h4 class="heading mt-2 mb-4">Bidang SD</h4>
                        <p class="para-desc mx-auto text-muted mb-0">Bidang Pembinaan Sekolah Dasar melaksanakan tugas
                            penyusunan bahan perumusan dan pelaksanaan kebijakan di Bidang Pembinaan Sekolah Dasar.</p>
    ...
    <section class="section">
        <div class="container mt-4">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <h4 class="title mt-3 mb-4">Bidang Pembinaan Sekolah Dasar Dinas Pendidikan</h4>
                        <p class="text-muted para-desc mb-0 mx-auto">Berikut <span
                                class="text-primary fw-bold">Pelayanan</span> di Bidang Pembinaan Sekolah Dasar Dinas
                            Pendidikan Tanjung Jabung Timur.</p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
            ...
            <div class="container">
                <div class="row">
                    @foreach ($bidangsds as $bidangsd)
                        <div class="mt-4 pt-2">
                            <div class="card work-process border-0 rounded shadow">
                                <div class="card-body">
                                    <h4 class="title">{{ strtoupper($bidangsd->judul) }}</h4>
                                    <hr>
                                    @if ($bidangsd->foto)
                                        @foreach (json_decode($bidangsd->foto) as $foto)
                                    ...
                                    {{-- @if ($bidangsd)
                                        @php
                                            $fileInfo = json_decode($bidangsd->file, true); // Mendekode data JSON dari kolom 'file'
                                    ...
                                    @endif --}}
                                    @php
                                        $fileInfo = json_decode($bidangsd->file, true);
