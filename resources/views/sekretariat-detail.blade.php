...
<body>
    ...
    <!-- Hero Start -->
    <section class="bg-half-260 bg-light d-table w-100" style="background: url('images/seo/bg.png') center center;">
        <div class="container">
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="title-heading">
                        <!-- <span class="badge rounded-pill bg-soft-primary"><b>Best SEO Service</b></span> -->
                        <h4 class="heading mt-2 mb-4">Sekretariat</h4>
                        <p class="para-desc mx-auto text-muted mb-0">Yang mempunyai tugas pokok menyiapkan perumusan
                            kebijakan teknis, pembinaan dan pelaksanaan program, keuangan, umum dan kepegawaian, hukum,
                            hubungan masyarakat dan organisasi serta pengoordinasian perencanaan dan pelaporan dinas di
                            lingkungan Dinas.</p>
                        <div class="mt-4 pt-2">
    ...
    <section class="section">
        <div class="container mt-4">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <h4 class="title mt-3 mb-4">Sekretariat Dinas Pendidikan</h4>
                        <p class="text-muted para-desc mb-0 mx-auto">Berikut <span
                                class="text-primary fw-bold">Pelayanan</span> di Sekretariat Dinas Pendidikan Tanjung
                            Jabung Timur.</p>
                    </div>
                </div>
                <!--end col-->
            ...
            <div class="container">
                <div class="row">
                    @foreach ($bidangsekre as $s)
                        <div class="mt-4 pt-2">
                            <div class="card work-process border-0 rounded shadow">
                                <div class="card-body">
                                    <h4 class="title">{{ strtoupper($s->judulnya) }}</h4>
                                    <!-- Menampilkan foto -->
                                    <hr>

                                    @if ($s->foto)
                                        @foreach (json_decode($s->foto) as $foto)
                                            <img src="{{ Voyager::image($foto) }}" alt="Foto Bidangsekre"
                                                style="width: 100%;">
                                        @endforeach
                                    @endif
                                    ...
                                    {{-- @if ($bidangsekre->isNotEmpty())
                                        @php
                                            $fileInfo = json_decode($bidangsekre->first()->file, true); // Mendekode data JSON dari kolom 'file'

                                            if ($fileInfo && is_array($fileInfo) && isset($fileInfo[0]['download_link'])) {
                                    ...
                                    @endif --}}
                                    @php
                                        $fileInfo = json_decode($s->file, true);
