...
@section('title', 'Bagian Umum dan Kepegawaian | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Bagian Umum dan Kepegawaian </h1>
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-white rounded shadow mb-0">
                                    <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Bagian Umum dan Kepegawaian
                                    </li>
                                </ul>
                            </nav>
                        </div>
            ...
            <div class="row">
                <div class="col-md-4 mt-4 pt-2">
                    ...
                    <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-4 sticky-bar"
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded active" id="tugas-kepegawaian-tab" data-bs-toggle="pill"
                                href="#tugas-kepegawaian" role="tab" aria-controls="tugas-kepegawaian"
                                aria-selected="true">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link rounded" id="data-kepegawaian-tab" data-bs-toggle="pill"
                                href="#data-kepegawaian" role="tab" aria-controls="data-kepegawaian"
                                aria-selected="false">
                                <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                                    <h6 class="mb-0"><i class="uil uil-postcard me-2 h5"></i> Data Kepegawaian</h6>
                                    <i class="uil uil-angle-right-b"></i>
                                </div>
                            </a>
                        </li>
                ...
                <div class="col-md-8 col-12 mt-4 pt-2">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active bg-white p-4 rounded shadow" id="tugas-kepegawaian"
                            role="tabpanel" aria-labelledby="tugas-kepegawaian-tab">
                            @foreach ($tugasPokokKepegawaian as $tugas)
                        ...
                        <div class="tab-pane fade bg-white p-4 rounded shadow" id="data-kepegawaian" role="tabpanel"
                            aria-labelledby="data-kepegawaian-tab">
                            @foreach ($dataKepegawaian as $data)
