            ...
            <div class="row">
                <div class="col-md-4 mt-4 pt-2">
                    ...
                    <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-4 sticky-bar"
                        ...
                        <li class="nav-item">
                            <a class="nav-link rounded active" id="proposal" data-bs-toggle="pill"
                                href="{{ route('tugas-kepegawaian') }}" role="tab" aria-controls="developing"
                                aria-selected="false">
                    ...
                    <ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-4 sticky-bar"
                        id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link rounded" id="proposal" data-bs-toggle="pill"
                                href="{{ route('data-kepegawaian') }}" role="tab" aria-controls="developing"
                                aria-selected="false">
                                <div class="text-start d-flex align-items-center justify-content-between py-1 px-2">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade bg-white show active p-4 rounded shadow" id="developing" role="tabpanel"
                            ...
                            @foreach ($tugasPokokKepegawaian as $tugas)
                                ...
                                <div class="mt-4">
                                    <img src="{{ asset('storage/' . $tugas->foto) }}" class="img-fluid" alt="">
                                </div>
                            @endforeach
                        </div><!--end teb pane-->
                    </div><!--end tab content-->
