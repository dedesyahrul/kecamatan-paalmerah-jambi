...
@section('title', 'Sejarah | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Sejarah </h1>
                        <div class="page-next">
                            ...
                            <div class="row">
                                <div class="col-md-2 d-none d-md-block">
                                    <ul class="list-unstyled text-center sticky-bar social-icon mb-0">
                                        ...
                                        <li>
                                            <a href="https://wa.me/?text={{ urlencode($sejarah->judul_sejarah . ' ' . url()->current()) }}"
                                                class="rounded" target="_blank">
                                ...
                                <div class="col-md-10">
                                    <h4 class="title mb-2">{{ $sejarah->judul_sejarah }}</h4>
                                    ...
                                    <ul class="list-unstyled d-flex justify-content-between mt-4">
                                        <li class="list-inline-item date text-muted"><i
                                            ...
                                            {{ \Carbon\Carbon::parse($sejarah->created_at)->translatedFormat('l, d F Y') }}
                                        </li>
                                    </ul>
                                    <img src="{{ $sejarah->foto_sejarah ? asset('storage/' . $sejarah->foto_sejarah) : asset('assets/images/DKI_Ok.png') }}"
