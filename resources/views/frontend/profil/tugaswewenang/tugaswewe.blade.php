...
@section('title', 'Tugas & Wewenang | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Tugas & Wewenang </h1>
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-white rounded shadow mb-0">
                                    <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Tugas & Wewenang</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
