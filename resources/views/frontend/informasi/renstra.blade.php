        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="page-next-level">
                    <h4 class="title"> Rencana Strategi </h4>
                    <div class="page-next">
                        <nav aria-label="breadcrumb" class="d-inline-block">
                            <ul class="breadcrumb bg-white rounded shadow mb-0">
                                <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                <li class="breadcrumb-item"><a>Rencana Strategi</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            @else
                                ...
                                <img src="{{ $renstra->foto ? asset('storage/' . $renstra->foto) : asset('assets/images/DKI_Ok.png') }}"
                                    class="img-fluid rounded-md shadow" alt="">
                                <small>{{ $renstra->text_foto }}</small>
                            @endif
                        </div>
                    </div>
                </div>
