        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="page-next-level">
                    <h4 class="title"> Sistem Akuntabilitas Kinerja Instansi Pemerintahan </h4>
                    <div class="page-next">
                        <nav aria-label="breadcrumb" class="d-inline-block">
                            <ul class="breadcrumb bg-white rounded shadow mb-0">
                                <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                <li class="breadcrumb-item"><a>SAKIP</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-6">
                <div class="card blog blog-detail border-0 shadow rounded">
                    <div class="card-body">
                        <h3 class="card-title">Sistem Akuntabilitas Kinerja Instansi Pemerintahan</h3>
                        <hr>
                        <div>
                            @if ($sakips->isEmpty())
                            ...
                            @else
                                ...
                                <img src="{{ $sakip->foto ? asset('storage/' . $sakip->foto) : asset('assets/images/DKI_Ok.png') }}"
                                    class="img-fluid rounded-md shadow" alt="">
                                <small>{{ $sakip->text_foto }}</small>
                            @endif
                        </div>
                    </div>
                </div>
