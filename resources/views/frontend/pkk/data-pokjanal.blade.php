...
@section('title', 'Data Pokja | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Data Pokja </h1>
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-white rounded shadow mb-0">
                                    <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Pokja</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
...
@section('content')
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    @if ($dataPokjanal->isEmpty())
                        <p>Tidak ada data Pokja.</p>
                    @else
                        @foreach ($dataPokjanal as $pokja)
                            <div class="row">
                                <div class="col-md-2 d-none d-md-block">
                                    <ul class="list-unstyled text-center sticky-bar social-icon mb-0">
                                        ...
                                        <li>
                                            <a href="https://wa.me/?text={{ urlencode($pokja->judul . ' ' . url()->current()) }}"
                                                class="rounded" target="_blank">
