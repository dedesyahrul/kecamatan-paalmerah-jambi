...
@section('title', 'Paud PKK | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Paud PKK </h1>
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-white rounded shadow mb-0">
                                    <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Paud PKK</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    @if ($paudPkk->isEmpty())
                        <p>Tidak ada data Paud PKK.</p>
                    @else
                        @foreach ($paudPkk as $paud)
                            <div class="row">
                                <div class="col-md-2 d-none d-md-block">
                                    <ul class="list-unstyled text-center sticky-bar social-icon mb-0">
                                        ...
                                        <li>
                                            <a href="https://wa.me/?text={{ urlencode($paud->judul . ' ' . url()->current()) }}"
                                                class="rounded" target="_blank">
                                ...
                                <div class="col-md-10">
                                    <h4 class="title mb-2">{{ $paud->judul }}</h4>
                                    <p class="text-muted">{{ $paud->keterangan }}</p>
                                    <ul class="list-unstyled d-flex justify-content-between mt-4">
                                        <li class="list-inline-item date text-muted"><i
                                            ...
                                            {{ \Carbon\Carbon::parse($paud->created_at)->translatedFormat('l, d F Y') }}
                                        </li>
                                    </ul>
                                    ...
                                    <img src="{{ asset('storage/' . $paud->foto) }}"
