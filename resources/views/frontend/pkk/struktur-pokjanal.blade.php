...
@section('title', 'Struktur Pokja | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Struktur Pokja </h1>
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="breadcrumb bg-white rounded shadow mb-0">
                                    <li class="breadcrumb-item"><a href="/">Beranda</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Struktur Pokja</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
...
@section('content')
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    @if ($strukturPokjanal->isEmpty())
                        <p>Tidak ada data Struktur Pokja.</p>
                    @else
                        @foreach ($strukturPokjanal as $struktur)
                            <div class="row">
                                <div class="col-md-2 d-none d-md-block">
                                    <ul class="list-unstyled text-center sticky-bar social-icon mb-0">
                                        ...
                                        <li>
                                            <a href="https://wa.me/?text={{ urlencode($struktur->judul . ' ' . url()->current()) }}"
                                                class="rounded" target="_blank">
                                ...
                                <div class="col-md-10">
                                    <h4 class="title mb-2">{{ $struktur->judul }}</h4>
                                    <p class="text-muted">{{ $struktur->keterangan }}</p>
                                    <ul class="list-unstyled d-flex justify-content-between mt-4">
                                        <li class="list-inline-item date text-muted"><i
                                            ...
                                            {{ \Carbon\Carbon::parse($struktur->created_at)->translatedFormat('l, d F Y') }}
                                        </li>
                                    </ul>
