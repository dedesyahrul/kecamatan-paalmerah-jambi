...
@section('title', 'Standar Pelayanan | Official Website Kecamatan Paal Merah | Pemerintah Kota Jambi')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="page-next-level title-heading">
                        <h1 class="text-white title-dark"> Standar Pelayanan </h1>
                        <div class="page-next">
...
@section('content')
    <section class="section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    @if ($standarPelayanans->isEmpty())
                        <p>Tidak ada data Standar Pelayanan.</p>
                    @else
                        @foreach ($standarPelayanans as $standarPelayanan)
                            <div class="row">
                                <div class="col-md-2 d-none d-md-block">
                                    <ul class="list-unstyled text-center sticky-bar social-icon mb-0">
                                        ...
                                        <li>
                                            <a href="https://wa.me/?text={{ urlencode($standarPelayanan->judul . ' ' . url()->current()) }}"
                                                class="rounded" target="_blank">
                                ...
                                <div class="col-md-10">
                                    <h4 class="title mb-2">{{ $standarPelayanan->judul }}</h4>
                                    <p class="text-muted">{{ $standarPelayanan->keterangan }}</p>
                                    <ul class="list-unstyled d-flex justify-content-between mt-4">
                                        <li class="list-inline-item date text-muted"><i
                                            ...
                                            {{ \Carbon\Carbon::parse($standarPelayanan->created_at)->translatedFormat('l, d F Y') }}
                                        </li>
                                    </ul>
