        ...
        <div class="row justify-content-center">
            <div class="col-lg-12 text-center">
                <div class="page-next-level">
                    <h4 class="title"> Undang-Undang </h4>
                    <div class="page-next">
                ...
                <div class="row">
                    ...
                    @else
                        <table class="table table-striped">
                            ...
                            <tbody>
                                @foreach ($undang_undangs as $undang_undang)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('detail-undang-undang', $undang_undang->id) }}"
                        ...
                        <!-- PAGINATION START -->
                        <div class="col-12">
                            {{ $undang_undangs->links('pagination::bootstrap-4') }}
                        </div><!--end col-->
                    @endif
                </div>
                <!-- PAGINATION END -->
