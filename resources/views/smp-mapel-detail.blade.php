...
<body>
        ...
        <div class="container">
            ...
            <div id="navigation">
                ...
                {{-- <ul class="navigation-menu">
                    <li><a href="/" class="sub-menu-item">PORTAL</a></li>
            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="title-heading">
                        ...
                        <h4 class="heading mt-2 mb-4">Bidang SMP</h4>
                        <p class="para-desc mx-auto text-muted mb-0">Bidang Pembinaan Sekolah Menengah Pertama
                            melaksanakan tugas penyusunan bahan perumusan dan pelaksanaan kebijakan di bidang Pembinaan
                            Sekolah Menengah Pertama.</p>
    ...
    <section class="section">
        <div class="container mt-4">
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <h4 class="title mt-3 mb-4">Bidang Pembinaan Sekolah Menengah Pertama Dinas Pendidikan</h4>
                        <p class="text-muted para-desc mb-0 mx-auto">Berikut <span
                                class="text-primary fw-bold">Pelayanan</span> di Bidang Pembinaan Sekolah Menengah
                            Pertama Dinas Pendidikan Tanjung Jabung Timur.</p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
            ...
            <div class="container">
                <div class="row">
                    @foreach ($bidangsmps as $bidangsmp)
                        <div class="mt-4 pt-2">
                            <div class="card work-process border-0 rounded shadow">
                                <div class="card-body">
                                    <h4 class="title">{{ strtoupper($bidangsmp->judul) }}</h4>
                                    <!-- Menampilkan foto -->
                                    <hr>
                                    @if ($bidangsmp->foto)
                                        @foreach (json_decode($bidangsmp->foto) as $foto)
                                    ...
                                    {{-- @if ($bidangsmps->isNotEmpty())
                                        @php
                                            $fileInfo = json_decode($bidangsmps->first()->file, true); // Mendekode data JSON dari kolom 'file'
                                    ...
                                    @endif --}}
                                    @php
                                        $fileInfo = json_decode($bidangsmp->file, true);
