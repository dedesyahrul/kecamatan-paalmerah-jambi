            ...
            <div class="row mt-5 justify-content-center">
                <div class="col-lg-12 text-center">
                    <div class="title-heading">
                        ...
                        <h4 class="heading mt-2 mb-4">Bidang PTK</h4>
                        <p class="para-desc mx-auto text-muted mb-0">Pendidik dan Tenaga Kependidikan bertugas
                            melaksanakan sebagian tugas Dinas Pendidikan meliputi Mutasi Pendidik dan Tenaga
                            Kependidikan, Pengembangan Pendidik dan Tenaga Kependidikan, serta Penghargaan dan
                            Perlindungan Pendidik dan Tenaga Kependidikan.</p>
                        <div class="mt-4 pt-2">
            ...
            <div class="row justify-content-center">
                <div class="col-12 text-center">
                    <div class="section-title mb-4 pb-2">
                        ...
                        <h4 class="title mt-3 mb-4">Bidang Pendidik dan Tenaga Kependidikan Dinas Pendidikan</h4>
                        <p class="text-muted para-desc mb-0 mx-auto">Berikut <span
                                class="text-primary fw-bold">Pelayanan</span> di Bidang Pendidik dan Tenaga Kependidikan
                            Dinas Pendidikan Tanjung Jabung Timur.</p>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
            <div class="container">
                <div class="row">
                    @foreach ($bidangptks as $ptk)
                        <div class="mt-4 pt-2">
                            <div class="card work-process border-0 rounded shadow">
                                <div class="card-body">
                                    <h4 class="title">{{ strtoupper($ptk->judulnya) }}</h4>
                                    <hr>
                                    @if ($ptk->foto)
                                        @foreach (json_decode($ptk->foto) as $foto)
                                            <img src="{{ Voyager::image($foto) }}" alt="Foto Bidang PTK"
                                                style="width: 100%;">
                                        @endforeach
                                    @endif
                                    <!-- Menampilkan file -->
                                    {{-- @if ($ptk->file && is_array(json_decode($ptk->file)))
                                        @php
                                            $fileInfo = json_decode($ptk->file, true);
                                        @endphp
                                        @if (isset($fileInfo[0]))
                                            @php
